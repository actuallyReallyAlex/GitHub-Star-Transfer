		...
		.then(answer => {
			...
			if (menuType === 'main') {
				...
				switch (answer[questions.name]) {
					case 'Account 1 - (Transfer FROM)':
						...
						createMenu([setupMenuQuestions1[0], setupMenuQuestions1[1]], 'editAccount1', 'edit');
						break;

					case 'Account 2 - (Transfer TO)':
						clear();
						printTitle('Edit Account 2');
						createMenu([setupMenuQuestions1[2], setupMenuQuestions1[3]], 'editAccount2', 'edit');
						break;
			...
			// TODO: Test for success or fail
				...
				switch (answer[questions.name]) {
					...
					case false:
						console.log('When you\'re ready, please respond \'Yes\' to return to the main menu.');
						timeout(2000, () => {
							createMenu(viewUserAccountQuestions, 'account', 'main');
						});
						break;
